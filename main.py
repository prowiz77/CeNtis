...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.yt_video_downloader_switch_darkmode = customtkinter.CTkSwitch(self.yt_video_downloader_frame, text="audio only",
                                 variable=switch_var_1, onvalue="on", offvalue="off", progress_color="#ff0000")
        ...
        self.yt_video_downloader_switch_darkmode = customtkinter.CTkSwitch(self.yt_video_downloader_frame_lightmode, text="audio only",
                                 variable=switch_var_3, onvalue="on", offvalue="off", progress_color="#ff0000")
        ...
        self.yt_video_downloader_switch_darkmode = customtkinter.CTkSwitch(self.yt_video_downloader_frame_turcoise, text="audio only",
                                 variable=switch_var_4, onvalue="on", offvalue="off", progress_color="#ff0000")
    ...
    def yt_audio_downloader_event(self):
        def download_link_func():
            url = self.yt_video_downloader_entry.get()
            if len(url) == 0:
                print("No input found...")
            else:
                print("Download Button Pressed - link:", self.yt_audio_downloader_entry.get())
