...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.main_optionmenu = customtkinter.CTkOptionMenu(self.main_frame, dynamic_resizing=False,
                                                        values=["Youtube Video Downloader", "Explicit Video Downloader", "Settings"], fg_color = "#dc161e", button_color = "#dc161e", button_hover_color = "#ee5157", dropdown_hover_color = "#ee5157")
        ...
        self.yt_video_downloader_logo_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.yt_video_downloader_entry = customtkinter.CTkEntry(self.yt_video_downloader_frame_darkmode, width=200, placeholder_text="enter youtube link", fg_color="#ff0000", border_color="#ff0000", placeholder_text_color="white")
        self.yt_video_downloader_entry.grid(row=1, column=0, padx=30, pady=(175, 15))
        self.yt_video_downloader_button_download = customtkinter.CTkButton(self.yt_video_downloader_frame_darkmode, text="Download", command=self.yt_video_downloader_event, width=200, fg_color = "#ff0000", hover_color = "#ff4c4c")
        self.yt_video_downloader_button_download.grid(row=3, column=0, padx=30, pady=(15, 15))
        ...
        self.yt_video_downloader_logo_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.yt_video_downloader_entry = customtkinter.CTkEntry(self.yt_video_downloader_frame_lightmode, width=200, placeholder_text="enter youtube link", fg_color="#695eff")
        self.yt_video_downloader_entry.grid(row=1, column=0, padx=30, pady=(175, 15))
        self.yt_video_downloader_button_download = customtkinter.CTkButton(self.yt_video_downloader_frame_lightmode, text="Download", command=self.yt_video_downloader_event, width=200, fg_color = "#695eff", hover_color = "#695eff")
        self.yt_video_downloader_button_download.grid(row=3, column=0, padx=30, pady=(15, 15))
        ...
        self.yt_video_downloader_logo_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.yt_video_downloader_entry = customtkinter.CTkEntry(self.yt_video_downloader_frame_turcoise, width=200, placeholder_text="enter youtube link", fg_color="#239f98", border_color="#239f98", placeholder_text_color="white")
        self.yt_video_downloader_entry.grid(row=1, column=0, padx=30, pady=(175, 15))
        self.yt_video_downloader_button_download = customtkinter.CTkButton(self.yt_video_downloader_frame_turcoise, text="Download", command=self.yt_video_downloader_event, width=200, fg_color = "#239f98", hover_color = "#ff4c4c")
        self.yt_video_downloader_button_download.grid(row=3, column=0, padx=30, pady=(15, 15))
