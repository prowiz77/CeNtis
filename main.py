...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.main_optionmenu = customtkinter.CTkOptionMenu(self.main_frame, dynamic_resizing=False,
                                                        values=["Youtube Video Downloader", "Explicit Video Downloader"], fg_color = "#dc161e", button_color = "#dc161e", button_hover_color = "#ee5157", dropdown_hover_color = "#ee5157")
        ...
        '''self.xxx_video_downloader_pornhub_logo = customtkinter.CTkImage(Image.open(current_path + "/logos/pornhub.png"), 
                                                size=(300, 155))#size=(300, 100))                                                
        self.xxx_video_downloader_pornhub_label = customtkinter.CTkLabel(self.xxx_video_downloader_frame, image=self.xxx_video_downloader_pornhub_logo, text="")
        self.xxx_video_downloader_pornhub_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.xxx_video_downloader_xhamster_logo = customtkinter.CTkImage(Image.open(current_path + "/logos/xhamster.png"), 
                                                size=(500, 280))#size=(300, 100))                                                
        self.xxx_video_downloader_xhamster_label = customtkinter.CTkLabel(self.xxx_video_downloader_frame, image=self.xxx_video_downloader_xhamster_logo, text="")
        self.xxx_video_downloader_xhamster_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.xxx_video_downloader_xvideos_logo = customtkinter.CTkImage(Image.open(current_path + "/logos/xvideos.png"), 
                                                size=(500, 280))#size=(300, 100))                                                
        self.xxx_video_downloader_xvideos_label = customtkinter.CTkLabel(self.xxx_video_downloader_frame, image=self.xxx_video_downloader_xvideos_logo, text="")
        self.xxx_video_downloader_xvideos_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.xxx_video_downloader_gotanynudes_logo = customtkinter.CTkImage(Image.open(current_path + "/logos/gotanynudes.png"), 
                                                size=(600, 80))#size=(300, 100))                                                
        self.xxx_video_downloader_gotanynudes_label = customtkinter.CTkLabel(self.xxx_video_downloader_frame, image=self.xxx_video_downloader_gotanynudes_logo, text="")
        self.xxx_video_downloader_gotanynudes_label.grid(row=0, column=0, padx=30 , pady=(100, 15))
        self.xxx_video_downloader_xnxx_logo = customtkinter.CTkImage(Image.open(current_path + "/logos/xnxx.png"), 
                                                size=(500, 280))#size=(300, 100))                                                
        self.xxx_video_downloader_xnxx_label = customtkinter.CTkLabel(self.xxx_video_downloader_frame, image=self.xxx_video_downloader_xnxx_logo, text="")
    ...
    def open_option_event(self):
        ...
        if value_optionmenu == "Youtube Video Downloader":
            ...
            self.main_frame.grid_forget()  # remove main frame
            self.bg_image_main_label.grid_forget() # remove default background image
            '''self.xxx_video_downloader_pornhub_label.grid_forget()
            self.xxx_video_downloader_xhamster_label.grid_forget()
            self.xxx_video_downloader_xvideos_label.grid_forget()
            self.xxx_video_downloader_gotanynudes_label.grid_forget()
            self.xxx_video_downloader_xnxx_label.grid_forget()'''
            self.bg_image_xxx_video_downloader_label.grid(row=0, column=0)
